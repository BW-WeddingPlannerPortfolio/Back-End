  ...
  return knex('planners').del()
    .then(function () {
      ...
      return knex('planners').insert([
        ...
        {id: 3, username: 'Amber Richards', password: 'vancerefrigeration', profile_pic: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60', home_location: 'Cleveland, OH', email: 'shopweddings@best.com'},
